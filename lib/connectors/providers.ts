    ...
    for (const course of courses) {
      ...
      for (const assignment of courseAssignments) {
        ...
        assignments.push({
          ...
          description: summarizeCanvasDescription(assignment.description),
...
function summarizeCanvasDescription(rawDescription?: string | null): string | undefined {
  if (!rawDescription) return undefined;

  // Canvas descriptions are frequently rich HTML; convert to readable plain text first.
